...
# Keylayout
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/uinput_nav.idc:$(TARGET_COPY_OUT_VENDOR)/usr/idc/uinput_nav.idc \
    $(LOCAL_PATH)/configs/uinput_nav.kl:$(TARGET_COPY_OUT_VENDOR)/usr/keylayout/uinput_nav.kl
...
# LiveDisplay
PRODUCT_PACKAGES += \
    vendor.lineage.livedisplay@2.1-service.motorola_berlin
...
# Overlays-RRO
PRODUCT_PACKAGES += \
    MotoCarrierConfigOverlayBerlin \
    MotoFrameworksOverlayBerlin \
    MotoSettingsOverlayBerlin \
    MotoSettingsProviderOverlayBerlin \
    MotoSystemUIOverlayBerlin \
    MotoWifiOverlayBerlin
